...
?>
                <div class="form-group email">
                    <label class="control-label" for="email">Enter Email (
                        <?php echo self::getEmailHint( $to ); ?>):
                    </label>
            ...
            <body>
                <section id="header">
                    <div class="container">
                        ...
                        <span> <?php if( self::isLoggedIn() ): ?> <a href="<?php echo self::makeUrl(); ?>">Main Menu</a> <a href="<?php echo self::makeUrl('logout'); ?>">Logout</a> <?php endif; ?> </span>
                    </div>
                </section>
