...
/**JSON_START**/ ?>
{
    "formId": "jqueryform-1550a6",
    "email": {
        "to": "smileofhopechildren@gmail.com",
        "cc": "",
        "bcc": "",
        "subject": "",
        "template": "You receive an email from {sender.fullname}.\n\nThe web form data:\n{dataTable}\n\nReference ID: {AutoID}\nIP: {IP}\nDate: {Date}\nTime: {Time}\nWebsite: {HTTP_HOST}\nReferer: {HTTP_REFERER}\n",
        "sendmail_from": "smileofhopechildren@gmail.com"
    },
    "admin": {
        "users": "admin:6c3a6",
    ...
    "fields": [
        {
            "label": "Let us know what's on your mind and we'll Contact You",
        ...
        },
        {
            ...
            "field_options": {
                ...
                "options": [
                    ...
                    {
                        "label": "I would like to volunteer",
                        "checked": false
                    },
                    {
                        "label": "Other",
        ...
        {
            "label": "Enter a Question or Comment",
